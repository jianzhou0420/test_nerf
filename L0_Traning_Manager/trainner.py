...
class Tranner:
    ...
    def test_grid(self):
        ...
        for i, batch in tqdm(enumerate(data_loader)):
            ...
            self.test_one_batch(batch['c2w'],batch['rgb'],batch['depth'],batch['direction'],batch['points'])
            if i==50:break
        torch.save(self.grid_encoding.memory,'./test1.pt')
    ...
    def test_one_batch(self,c2w,rgb,depth,direction,points):

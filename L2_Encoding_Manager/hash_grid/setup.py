...
nvcc_flags = [
    '-O3', '-std=c++14',
    '-U__CUDA_NO_HALF_OPERATORS__', '-U__CUDA_NO_HALF_CONVERSIONS__', '-U__CUDA_NO_HALF2_OPERATORS__','-G'
]
...
setup(
    name='test', # package name, import this to use python API
    ext_modules=[
        CUDAExtension(
            name='_test', # extension name, import this to use CUDA API
